...
def load_and_preprocess_image(image_data, target_size=(224, 224)):
    image = ImageOps.fit(image_data, target_size, Image.LANCZOS) # type: ignore
...
if menu_selection == "Home":
    ...
    age = st.sidebar.number_input("Age", min_value=0, max_value=60, value=30, step=1)
    ...
    logo_image = st.image("pmay-logo.png")
    st.write("Welcome to Dwell Well!")
    st.write("Dwell Well sprouted from a simple question: how can we leverage technology to ensure the safety and well-being of families living under Pradhan Mantri Gramin Awas Yojana - Gramin homes? The answer? Machine learning magic!")
...
footer = """
Copyright © 2024 Dwell Well. All rights reserved.
"""
